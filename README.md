...
Not much, just make sure you have node installed on your machine.
You can download and install node [here](https://nodejs.org/dist/v22.20.0/node-v22.20.0-x64.msi)
...
3. After running the first script, now run `2 - run-preview.bat` to start the app.
   Every time you need to use the app just run the second script.
